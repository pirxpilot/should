...
export default function (_should, Assertion) {
  /**
   ...
   * NaN.should.be.NaN();
   */
  Assertion.add('NaN', function (...args) {
    this.assertZeroArguments(args);
    this.params = { operator: 'to be NaN' };

    // biome-ignore lint/suspicious/noSelfCompare: hacky way to check NaN
   ...
   */
  Assertion.add('Infinity', function (...args) {
    this.assertZeroArguments(args);
    this.params = { operator: 'to be Infinity' };

    this.is.a.Number().and.not.a.NaN().and.assert(!Number.isFinite(this.obj));
  });
