...
import { PromisedAssertion } from '../assertion.js';
...
export default function (should, Assertion) {
   ...
   */
  Assertion.add('Promise', function (...args) {
   ...
   * });
   */
  Assertion.prototype.fulfilled = function Assertion$fulfilled(...args) {
    this.assertZeroArguments(args);
   ...
   * });
   */
  Assertion.prototype.rejected = function (...args) {
    this.assertZeroArguments(args);
    ...
    get() {
      ...
      return new PromisedAssertion(
        this.obj.then(obj => {
          ...
          a.negate = this.negate;
          a.anyOne = this.anyOne;
